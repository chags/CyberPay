<?php
  ...
  if( $log["erro"] == false ){
    header("location: " . $app->index() . "/panel/listar-orcamentos" . Helper::notification(true,$log["mensagem"]));
}else{
    header("location: " . $app->index() . "/panel/listar-orcamentos" . Helper::notification(false, $log["mensagem"]));
}
